        ...
        <div class="result-wrap">
           ...
           <li>
             <%=StringUtil.notNull(message)%>
               ...
               <li>
           查看<a href="admin/ProductTypeServlet?method=type_to_attribute_list&id=<%=typeId%>">属性列表</a>&nbsp;或&nbsp; 查看<a href="admin/ProductTypeServlet?method=type_to_attribute_value_list&id=<%=attributeId%>">属性值列表</a>
             </li>
              </ul>
 </div>
 </div>
