  ...
  <div class="container clearfix">
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span><span class="crumb-name">库存列表</span>
            </div>
        </div>
           ...
           <form name="delform" id="delform"  method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="admin/ProductServlet?method=admin_product_stock_edit&code=<%=code%>"><i class="icon-font">&#xe026;</i>修改库存</a>
                        &nbsp;<a href="admin/ProductServlet?method=admin_product_list"><i class="icon-font">&#xe026;</i>返回产品列表</a>
                    </div>
                </div>
