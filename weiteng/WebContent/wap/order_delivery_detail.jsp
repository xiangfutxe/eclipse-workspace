...
OrderDelivery p = (OrderDelivery)request.getAttribute("orders");
List<OrderDeliveryDetail> slist = (List<OrderDeliveryDetail>)request.getAttribute("coll");
       ...
       <ul class="list-group">
		           ...
		           <li class="list-group-item hproduct clearfix">
					...
					<p>
					        ...
					        <%}else if(p.getOrderType()==2){ %>特买购物
					         <%}else if(p.getOrderType()==3){ %>积分购物
					        <%} %>
					        /
					        <%if(p.getState()==1){%>待确认
					        <%}else if(p.getState()==2){ %>代发货
