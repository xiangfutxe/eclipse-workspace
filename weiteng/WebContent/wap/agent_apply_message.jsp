...
<header class="header">
	<div class="fix_nav">
		<div class="nav_inner">
			<a class="nav-left back-icon" href="UserServlet?method=user_home">首页</a>
...
<div class="container ">
    <div class="row rowcar">
        ...
        <ul class="list-group">
		            ...
		            <p> <span  class="pull-left font-18">${message }</span>
		            ...
		            </p>  <p> <span  class="font-14">
					账号：3602014309200070518
