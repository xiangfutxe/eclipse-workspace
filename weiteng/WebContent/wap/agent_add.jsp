...
<div id="container">
    <div class="address_main">
     <input type="hidden" name="token" id="token" value="<%=token%>"/> 
        ...
        <div class="line"><input type="text" placeholder="联系电话" id="phone" name="phone" value=""></div>
        ...
        <div class="line"><input type="text" placeholder="详细地址" id="address" name="address" value=""></div>
    </div>
