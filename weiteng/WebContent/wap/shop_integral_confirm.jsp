...
<form action="OrderServlet?method=shop_integral_save" method="post" id="myform" name="myform">
<input type="hidden" id="token" name="token" value="${sessionScope.token}"/>
<div class="container ">
    <div class="row rowcar">
      <ul class="list-group">
		            <li class="list-group-item text-black">
		            <a href="AddressServlet?method=list&tag=3">
		           ...
		           <c:if test="${address==null}">
		            <p><span  class="pull-left font-16">+请点击添加地址></span></p>
		           </c:if>
		            <br>
		            </a>
		        </li></ul>
     <%if(plist!=null){
    		...
    		integral=ArithUtil.add(integral,ArithUtil.mul(plist.get(i).getIntegral(),plist.get(i).getNum()));
    		%>
        <ul class="list-group">
		  ...
		  <ul class="list-group pt0">
			<li  class="list-group-item tip">
				...
				<span class="pull-right pr15 pt2" id="zhifu">转账汇款</span>
			</li>
		<li  class="list-group-item tip">
...
<div class="fixed_inner">
    <div class="pay-point">
         <p>总计:<em class="red f16">¥<span id="totalPrice"><%=totalPrice%></span></em>;
        积分:<em class="red f16"><span id="integral"><%=integral%></span></em></p>
    </div>
