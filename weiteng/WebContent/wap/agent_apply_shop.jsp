...
<div class="container ">
    <div class="row rowcar">
      <ul class="list-group">
		            ...
		            <a href="AddressServlet?method=list&tag=5">
     ...
     <%if(plist!=null){
		            ...
		            <li class="list-group-item hproduct clearfix">
			                ...
			                <div class="p-info">
			                   <p class="p-title"><%=plist.get(i).getProductName()%></p>
		                    	...
		                    	<p class="p-origin">
			                       单价：¥<%=plist.get(i).getPrice()%>；数量：<%=plist.get(i).getNum()%>；
			                    </p>
			                </div>
		            </li>
					</ul>
		...
		<li  class="list-group-item tip">
						...
						<span class="left-detail">配送方式</span>
...
<div class="fixed_inner">
    ...
    <div class="buy-btn-fix">
        <a href="javascript:void(0)"  id="submitShopCart" class="btn-cart">提交申请</a>
    </div>
</div>
</div>
</form>
