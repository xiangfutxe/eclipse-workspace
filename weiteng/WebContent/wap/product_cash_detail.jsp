...
<div class="container">
    ...
    <div class="row gary-bg">
       <form action="OrderServlet?method=shop_cash_confirm" id="myform" method="post">
...
<div class="fixed-foot">
	<div class="fixed_inner">
		...
		<a class="cart-wrap" href="OrderServlet?method=shop_cash_cart">
			<i class="i-cart"></i>
			<span>购物车</span>
...
function addShopCart(){
	$.ajax({
		type : "post",
		url : "OrderServlet?method=add_cash_cart",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
		data : {//设置数据源
			num : $("#prodCount").val(),
			id:$("#id").val()
