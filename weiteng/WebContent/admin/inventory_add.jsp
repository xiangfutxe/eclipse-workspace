...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
     ...
     <form action="InventoryServlet?method=save" id="myform" method="post">
    <ul class="forminfo">
   ...
   <li><label>联系人<b>*</b></label>
    <input name="linkman" id="linkman" type="text" class="dfinput"/><i id="linkmanTag"></i></li>
     <li><label>联系电话<b>*</b></label>
    <input name="phone" id="phone" type="text" class="dfinput" /><i id="phoneTag"></i></li>
     <li><label>联系地址<b>*</b></label>
    <input name="address" id="address" type="text" class="dfinput"/><i id="addressTag"></i></li>
...
$(function() {
  ...
  $("#name").blur(function() {
		$.ajax({
				type : "post",
				url : "InventoryServlet?method=isExit",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
					name : $("#name").val()
