...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
     ...
     <form action="DeptServlet?method=saveDept" id="myform" method="post">
    <ul class="forminfo">
    ...
    <li><label>部门描述<b>*</b></label><input name="remark" id="remark" type="text" class="dfinput" /><i id="remarkTag"></i></li>
...
$(function() {
  ...
  $("#name").blur(function() {
		$.ajax({
				type : "post",
				url : "DeptServlet?method=isDeptExit",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
					name : $("#name").val()
