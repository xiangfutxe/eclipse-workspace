...
public class AccountSupplementServlet extends HttpServlet {
	...
	String pageSizeStr = StringUtil.notNull(request.getParameter("pageSizeStr"));
		...
		try {
			...
			String request_dispatcher ="account_supplement.jsp";
			if (!message.equals("")) {
					request.setAttribute("message", message);
					request_dispatcher ="account_supplement_message.jsp";
			}else if(!error.equals("")) {
				request.setAttribute("error", error);
				if(lt==0) request_dispatcher ="account_supplement_error.jsp";
				else request_dispatcher ="error_login.jsp";
			}else {
				request_dispatcher ="account_supplement.jsp";
			}
