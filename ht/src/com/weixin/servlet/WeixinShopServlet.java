 ...
 *  
 */  
public class WeixinShopServlet extends HttpServlet {  
...
String message ="";
		...
		if(db.createConn()){
          ...
          snsUserInfo.setId(weixinUser.getId());
          snsUserInfo.setBranchId(weixinUser.getBranchId());
          snsUserInfo.setBranchName(weixinUser.getBranchName());
          snsUserInfo.setEmoney(weixinUser.getEmoney());
          snsUserInfo.setRankManage(weixinUser.getRankManage());
          snsUserInfo.setUserId(weixinUser.getUserId());
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("weixin/index_rect.jsp");
