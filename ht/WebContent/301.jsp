...
<div class="head clearfix">
    ...
    <div class="tel">
  <span><%if(user==null){ %><a href="UserServlet.do?method=login">会员登录</a>
	...
	<div class="second">   
        <div class="scd_m clearfix">
            ...
            <div class="scd_mr">
            	...
            	<div class="ht_table">
            	<h2>当前位置：全球分会-><a  href="BranchServlet.do?method=B_301">全景规划</a></h2>
            	</div>
            	<div class="ht_table">
            	<ul>
            	 <li class="h2_1"><img alt="" src="images/h2.png">全景规划</li>
                 <li>&nbsp;</li>
       		 </ul>
               </div>
            </div>
