...
<div class="nav_bg">
	<div class="nav_m">
    	<ul id="nav">
            ...
            <li><a href="AboutServlet.do?method=A_201"><span class="now">关于我们</span></a>
                            <ul>
	...
	<div class="second">   
        <div class="scd_m clearfix">
            ...
            <div class="scd_mr">
            	...
            	<div class="ht_table">
            	<h2>当前位置：关于我们-><a href="AboutServlet.do?method=A_203">企业愿景</a></h2>
            	</div>
            	<div class="ht_table">
            	<ul>
            	 <li class="h2_1"><img alt="" src="images/h2.png">企业愿景</li>
                	<p>&nbsp;</p>
