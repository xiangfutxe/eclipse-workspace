...
<div class="nav_bg">
	<div class="nav_m">
    	<ul id="nav">
           ...
           <li><a href="PhilanthropyServlet.do?method=P_501"><span  class="now">慈善公益</span></a>
             <ul>
	...
	<div class="second">   
        <div class="scd_m clearfix">
            ...
            <div class="scd_mr">
            	...
            	<div class="ht_table">
            	<h2>当前位置：慈善公益-><a  href="PhilanthropyServlet.do?method=P_501">公益足迹</a></h2>
            	</div>
            	<div class="ht_table">
            	<ul>
            	 <li class="h2"><img src="images/501.jpg"/></li>
							<%
				...
				<li class="h1">
            	<a class="link-update"
									href="PhilanthropyServlet.do?method=P_501_1&id=<%=as.getId()%>"><%=StringUtil.notNull(as.getTitle())%></a>
