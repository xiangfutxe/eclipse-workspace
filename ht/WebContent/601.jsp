	...
	<div class="second">   
        <div class="scd_m clearfix">
            ...
            <div class="scd_mr">
            	...
            	<div class="ht_table">
            	<h2>当前位置：名媛学堂-><a  href="BranchServlet.do?method=S_601">学院宗旨</a></h2>
            	</div>
            	<div class="ht_table">
            	<ul>
            	 <li class="h2_1"><img alt="" src="images/h2.png">学院宗旨</li>
            	  
            	  <li>
            	  <p>&nbsp;</p>
            	  <p>弘扬中华传统文化，展现旗袍风采、彰显东方女性魅力</p>
            	  <p>&nbsp;</p>
            	  <p>愿景：引领女性修为典范</p>
            	   <p>&nbsp;</p>
            	  <p>使命：身体力行、内外兼修、助国旺家</p>
            	   <p>&nbsp;</p>
            	  <p>价值观：内敛、包容、传承、互助、奉献</p>
            	   <p>&nbsp;</p>
            	    <p>宣传口号：弘扬中华女德，共建幸福家园</p>
            	  </li>
                 <li>&nbsp;</li>
       		 </ul>
               </div>
