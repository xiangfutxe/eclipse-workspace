...
<div class="nav_bg">
	<div class="nav_m">
    	<ul id="nav">
           ...
           <li  class="now"><a href="SchoolServlet.do?method=S_601">名媛学堂</a>
	...
	<div class="second">   
        <div class="scd_m clearfix">
            ...
            <div class="scd_mr">
            	...
            	<div class="ht_table">
            	<h2>当前位置：名媛学堂-><a  href="BranchServlet.do?method=S_602">视频在线</a></h2>
            	</div>
            	<div class="ht_table">
            	<ul>
...
<param name="movie" value="${pageContext.request.contextPath }/swf/piao.wmv">
<param name="quality" value="high">
<param name="wmode" value="transparent" />
<embed src="<%=StringUtil.notNull(video.getVideoUrl())%>" allowFullScreen='true' quality='high' width='480' height='400' align='middle' allowScriptAccess='always' type='application/x-shockwave-flash'></embed>
            	  </object></li>
                 <li>&nbsp;</li>
       		 	</ul>
       		 	 <p>&nbsp;</p>
