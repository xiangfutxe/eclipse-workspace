	...
	<div class="second">   
        <div class="scd_m clearfix">
            ...
            <div class="scd_mr">
            	...
            	<div class="ht_table">
            	<h2>当前位置：名媛学堂-><a  href="PhilanthropyServlet.do?method=S_602">视频在线</a></h2>
            	</div>
            	<div class="ht_table">
            	<ul>
            	 <li class="h2"><img src="images/602.jpg"/></li>
							<%
							...
							%>
				<li class="h5">
				<img src="upload/video/<%=as.getImageUrl() %>" alt="暂无图片" width="248px" height="186px"/>
            	<a class="link-update"
									href="SchoolServlet.do?method=S_602_1&id=<%=as.getId()%>">
									<%if(StringUtil.notNull(as.getTitle()).length()>10){%><%=StringUtil.notNull(as.getTitle()).substring(0,10)%>...
									<%}else{%><%=StringUtil.notNull(as.getTitle())%>
									<%}%>
									</a>
								
								<span><%=StringUtil.parseToString(
										as.getEntryTime(),
										DateUtil.yyyyMMdd)%>
										</span>
										</li>
