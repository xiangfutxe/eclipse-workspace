...
VideoInfo video =(VideoInfo) request.getAttribute("ht_video_info");
%>
	...
	<div class="second">   
        <div class="scd_m clearfix">
            ...
            <div class="scd_mr">
            	...
            	<div class="ht_table">
            	<h2>当前位置：名媛学堂-><a  href="SchoolServlet.do?method=S_602">视频在线</a></h2>
            	</div>
            	<div class="ht_table">
            	<ul>
            	 <li class="h2_1"><img alt="" src="images/h2.png"><%=StringUtil.notNull(video.getTitle()) %></li>
            	  
            	  <li class="h6">
 <video id="example_video_1" class="video-js vjs-default-skin vjs-big-play-centered" controls preload="none" width="560" height="420"
      poster="<%=path %>/upload/video/<%=video.getImageUrl() %>"
      data-setup="{}">
    <source src="<%=path %>/upload/video/<%=video.getVideoUrl() %>" type='video/mp4' />
      <source src="<%=path %>/upload/video/<%=video.getVideoUrl2() %>" type='video/ogg' />
    <source src="<%=path %>/upload/video/<%=video.getVideoUrl3() %>" type='video/webm' />
    ...
    <track kind="subtitles" src="demo.captions.vtt" srclang="en" label="English"></track><!-- Tracks need an ending tag thanks to IE9 -->
       		 	 ...
       		 	 <p>&nbsp;</p>
       		 	<ul>
            	 <li class="h2_1"><img alt="" src="images/h2.png">视频简介</li>
            	  
            	  <li>
            	  <p>&nbsp;</p>
            	  </li>
                 <li><p><%=StringUtil.notNull(video.getIntroduction()) %></p>
                  <p>&nbsp;</p></li>
       		 	</ul>
               </div>
            </div>
