...
<form action="ProductServlet?method=shop_save_1" method="post" id="myform" name="myform">
<div class="container ">
        ...
        <ul class="list-group">
    		...
    		%>
		            <li class="list-group-item hproduct clearfix">
			                ...
			                <div class="p-info">
			                    <a href="ProductServlet?method=detail_1&id=<%=slist.get(i).getCode()%>"><p class="p-title"><%=slist.get(i).getName()%></p></a>
		                    	<p class="p-attr">
