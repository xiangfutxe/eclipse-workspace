...
<% 
List<Product> slist = (List<Product>) request.getSession().getAttribute("vip_shop_list");
...
<form action="OrderServlet?method=vip_save" method="post" id="myform" name="myform">
<div class="container ">
        ...
        <ul class="list-group">
    		...
    		%>
		            <li class="list-group-item hproduct clearfix">
			                ...
			                <div class="p-info">
			                    <a href="ProductServlet?method=detail&id=<%=slist.get(i).getCode()%>"><p class="p-title"><%=slist.get(i).getName()%></p></a>
		                    	<p class="p-attr">
