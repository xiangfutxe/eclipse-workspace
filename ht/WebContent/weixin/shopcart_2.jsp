...
<div class="fanhui_cou">
    ...
    <div class="fix_nav">
        <div class="nav_inner">
            ...
            <div class="tit">积分购物车</div>
        </div>
    </div>
</header>
<form action="ProductServlet?method=shop_cart_save_2" method="post" id="myform" name="myform">
<div class="container ">
        ...
        <ul class="list-group">
		            ...
		            <li class="list-group-item clearfix">
						...
						<div class="btn-group btn-group-sm control-num">
		                    <a  href="ProductServlet?method=disDe_2&tag=<%=i%>" class="btn btn-default"><span class="glyphicon glyphicon-minus gary"></span></a>
		                    ...
		                    <a  href="ProductServlet?method=increate_2&tag=<%=i%>" class="btn btn-default"><span class="glyphicon glyphicon-plus gary"></span></a>
		                </div>
					</li>
					</ul>
					<%}}%>
