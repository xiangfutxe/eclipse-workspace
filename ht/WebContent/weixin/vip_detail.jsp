...
<form action="OrderServlet?method=vip_select" method="post" id="myform" name="myform">
			  ...
			  <li>
				...
				<div class="count_div" style="height: 30px; width: 130px;">
					<a href="javascript:void(0);" class="minus" ></a>
					  <input type="text" class="count" value="1" name="prodCount" id="prodCount" readonly="readonly"/>
...
<div class="fixed-foot">
	<div class="fixed_inner">
		...
		<div class="buy-btn-fix">
		    <a class="btn btn-danger btn-buy" id="buyNow" href="javascript:void(0);">立即购买</a>
		</div>
	</div>
</div>
</form>
