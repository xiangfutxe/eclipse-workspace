...
<div class="nav_bg">
	<div class="nav_m">
    	<ul id="nav">
            ...
            <li><a href="BranchServlet.do?method=B_305"><span class="now">全球分会</span></a>
               <ul>
	...
	<div class="second">   
        <div class="scd_m clearfix">
            ...
            <div class="scd_mr">
            	...
            	<div class="ht_table">
            	<h2>当前位置：全球分会-><a  href="BranchServlet.do?method=B_305">分会资讯</a></h2>
            	</div>
            	<div class="ht_table">
            	<ul>
            	 <li class="h2"><img src="images/305.jpg"/></li>
							<%
				...
				<li class="h1">
            	<a class="link-update"
									href="BranchServlet.do?method=B_305_1&id=<%=as.getId()%>"><%=StringUtil.notNull(as.getTitle())%></a>
