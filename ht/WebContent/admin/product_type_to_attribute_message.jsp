   ...
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span>产品管理
             ...
             <span class="crumb-step">&gt;</span>
             <span><a href="admin/ProductTypeServlet.do?method=attribute_value_list&id=<%=attributeId%>">属性值列表</a></span>
            <span class="crumb-step">&gt;</span>
            <span>信息提示</span>
            </div>
        </div>
        <div class="result-wrap">
           ...
           <li>
             <%=StringUtil.notNull(message)%>
               ...
               <li>
           继续<a href="admin/ProductTypeServlet?method=attribute_value_add">  添加产品属性值</a>&nbsp;或&nbsp;查看<a href="admin/ProductTypeServlet?method=attribute_value_list&id=<%=attributeId%>">产品属性值列表</a>
             </li>
              </ul>
 </div>
 </div>
