  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
           ...
           <span><a href="admin/ProductTypeServlet?method=type_list">分类列表</a></span>
            <span class="crumb-step">&gt;</span><span>新增分类</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/ProductTypeServlet?method=type_save" method="post" id="myform" name="myform">
...
$(function() {
	$("#typeName").blur(function() {
		$.ajax({
				type : "post",
				url : "admin/ProductTypeServlet?method=type_isExit",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
