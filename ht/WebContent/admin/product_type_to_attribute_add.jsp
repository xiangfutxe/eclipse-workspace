...
<html>
  <head>
	...
	$("#reback").click(function(){
         ...
         $('#delform').attr("action", "admin/ProductTypeServlet?method=type_to_attribute_list");
       	 $('#delform').submit();
	...
	$("#sub").click(function(){
		...
		if (!confirm("确认要提交保存？")) {
         ...
         $('#delform').attr("action", "admin/ProductTypeServlet?method=type_to_attribute_save");
       		 $('#delform').submit();
       		  return true;
        }
   ...
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span><span class="crumb-name">属性选择</span>
             <span class="crumb-step">&gt;</span><span class="crumb-name">添加属性</span>
            </div>
        </div>
        ...
        <div class="result-wrap">
           ...
           <input id="id" name="id" type="hidden" value="<%=typeId %>"/>
           <input id="token" name="token" type="hidden" value="<%=token %>"/>
			...
			<%}
						 ...
						 <tr>
						 <td colspan="3">暂无属性值信息，请点击<a href="admin/ProductTypeServlet?method=attribute_add">添加产品属性。</a></td>
						  </tr>
						 <%} %>
