           ...
           <form name="delform" id="delform"  method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="admin/ProductTypeServlet?method=attribute_value_add"><i class="icon-font">&#xe026;</i>新增属性值</a>
                    </div>
                </div>
						...
						if(pager!=null){
						 ...
						 <td> <%=StringUtil.parseToString(pt.getEndTime(), DateUtil.yyyyMMddHHmmss)%></td>
						  <td>   <a
										...
										| <a
										class="link-del"
										href="admin/ProductTypeServlet?method=attribute_value_edit&id=<%=pt.getId()%>">修改</a>
                            </td>
						 </tr>
			<%}}
						}else{ %>
						 <tr>
						 <td colspan="5">暂无属性值信息，请点击<a href="admin/ProductTypeServlet?method=attribute_value_add">添加产品属性值。</a></td>
						  </tr>
						 <%} %>
                    </table>
