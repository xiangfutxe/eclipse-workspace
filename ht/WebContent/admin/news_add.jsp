               	...
               	<tr>
               		...
               		<td>
                        <select class="common-text" id="sort" name="sort">
                           ...
                           <option value='2'>分会动态</option>
                            <option value='3'>总部竞赛</option>
                            <option value='4'>分部竞赛</option>
                            <option value='5'>环球之旅</option>
                            <option value='6'>公益足迹</option>
                            <option value='7'>善行有我</option>
                            <option value='8'>国学传播</option>
                           </select>
