...
<div id="container">
    <div class="address_main">
     <input type="hidden" name="token" id="token" value="<%=token%>"/> 
        ...
        <div class="line"><input type="text" placeholder="收件人" id="reciver" name="reciver" value=""></div>
        <div class="line"><input type="text" placeholder="联系电话" id="tel" name="tel" value=""></div>
        ...
        <div class="line"><input type="text" placeholder="详细地址" id="s_adr" name="s_adr" value=""></div>
    </div>
   ...
   function copyText(){
    if (!confirm("确认保存收货地址？")) {
            ...
            if($("#reciver").val()=="") error=error+"收件人不能为空！/n";
             if($("#tel").val()=="") error=error+"手机号码不能为空！/n";
              if($("#s_adr").val()=="") error=error+"详细地址不能为空！/n";
              if(error==""){
             $('#myform').submit();
             return true;
             }else  return false;
