...
<div class="topbar-wrap white">
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            <h1 class="topbar-logo none"><a href="admin/index.jsp" class="navbar-brand" target=main>后台管理界面</a></h1>
            <ul class="navbar-list clearfix">
                <li><a class="on" href="admin/index.jsp" target=main>内而外后台管理系统</a></li>
            </ul>
        </div>
