  ...
  <div class="container clearfix">
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">会员管理</span><span class="crumb-step">&gt;</span><span class="crumb-name">团队管理</span></div>
        </div>
           ...
           <form name="delform" id="delform"  method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="admin/TeamServlet.do?method=add"><i class="icon-font">&#xe026;</i>新增团队</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
						...
						if(pager!=null){
							...
							%>
					  	<tr>
					  	   <td> <%=StringUtil.notNull(team.getTeamId()) %></td>
						 <td> <%=StringUtil.notNull(team.getTeamName()) %></td>
						 <td> <%=StringUtil.notNull(team.getUserName()) %>(<%=StringUtil.notNull(team.getUserId()) %>)</td>
					
						  <td> <%=StringUtil.parseToString(team.getEntryTime(), DateUtil.yyyyMMddHHmmss) %></td>
						  <td>
                                -
                            </td>
						 </tr>
						<%}}
						 ...
						 <tr>
						 <td colspan="5">暂无团队信息，请点击<a href="admin/TeamServlet.do?method=add">添加团队。</a></td>
						  </tr>
						 <%} %>
						</table>
