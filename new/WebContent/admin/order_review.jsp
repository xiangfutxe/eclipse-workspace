...
<body>
		...
		<div class="main-wrap">
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.jsp">首页</a><span
						...
						class="crumb-step">&gt;</span><span class="crumb-name">订单出库</span>
				</div>
			</div>
			...
			<div class="result-title">
					<div class="result-list">
						<a href="admin/OrderServlet.do?method=admin_order_review_ylist"><i
				...
				<div class="result-content">
					<table class="result-tab" width="99%">
						<tr>
							...
							<th>订单编号</th><th>订单类型</th><th>总金额</th><th>快递费</th><th>会员信息</th><th>收件人</th><th>联系电话</th><th>订单日期</th><th>当前状态</th><th>操作</th>
 ...
 <td><%=StringUtil.decimalFormat(order.getPrice()) %>
   ...
   <td><%=StringUtil.decimalFormat(order.getFee()) %>
   </td>
