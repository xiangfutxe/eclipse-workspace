   ...
   <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/MessageServlet.do?method=admin_reply_save"  method="post" id="saveform" name="saveform">
                        ...
                        <tbody>
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                                    <textarea id="adminMsg" name="adminMsg"></textarea> &nbsp;<span id="msgTag"></span>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
