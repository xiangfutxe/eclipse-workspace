...
ChargeApply apply = (ChargeApply)request.getAttribute("apply");
if(admin==null) {
out.println("<script>");
  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span><span>充值申请</span>
...
$(function() {
	...
	$("#sbtn").click(function(){
		if (!confirm("确认要提交修改会员备注提示？")) {
            return false;
        }else{
			$('#myform').attr("action", "admin/ChargeApplyServlet.do?method=apply_comments_update");
	       	$('#myform').submit();
       		 return true;
