  ...
  <div class="container clearfix">
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">库存管理</span><span class="crumb-step">&gt;</span><span class="crumb-name">仓库列表</span></div>
        </div>
