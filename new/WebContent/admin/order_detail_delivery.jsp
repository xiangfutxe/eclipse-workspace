 ...
 <tr <%if(t%2==1){%>class="even"<%}%>>
					...
					<div class="result-title">
						...
						<br>
							...
							&nbsp;<%if(orders.getState()==2){ %><input type="button" class="btn btn6" id="deliveryBtn" value="确认出库"/><%} %></p>
						</div>
					</div>
				</form>
			</div>
	...
	$(document).ready(function() {
		$("#deliveryBtn").bind("click", function() {
			...
			window.event.returnValue = false;
		 	...
		 	$('#myform').attr("action", "admin/OrderServlet.do?method=admin_order_delivery_express");
       		$('#myform').submit();
			return true;
		}
