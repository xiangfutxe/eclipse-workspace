  ...
  <head>
	...
	$("#abtn").click(function(){
		if (!confirm("确认提交申请？")) {
        	...
        	if($("#inventoryId").val()=="") error=error+"未选择仓库，";
  ...
  <div class="container clearfix">
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span><span class="crumb-name">库存管理</span><span class="crumb-step">&gt;</span><span class="crumb-name">新增入库</span></div>
        </div>
       
        <div class="result-wrap">
           <form action="admin/InventoryServlet.do?method=save" method="post" id="saveform" name="saveform">
