  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span>会员管理<span class="crumb-step">&gt;</span><span>服务中心</span><span class="crumb-step">&gt;</span><span>资料修改</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                   <form action="admin/CenterServlet.do?method=admin_edit_save" method="post" id="myform" name="myform">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                             ...
                             <tr>
                                ...
                                <td>
                               <%if(center.getType()==1) {%> 社区店（宅地）
								<%}else if(center.getType()==2) {%>社区店（落地）
								<%}else if(center.getType()==3) {%>旗舰店（落地）
								<%} %></td>
                            </tr>
                               <tr>
							...
							id="userId" value="<%=center.getUserId()%>">
                                </td>
                            </tr>
                            <tr>
                                <th width="150px"><i class="require-red">*</i>负责人姓名：</th>
                                <td><input type="text" name="userName"
							id="userName" value="<%=center.getUserName()%>">
                                </td>
                            </tr>
                            <tr>
							...
							id="license" value="<%=StringUtil.notNull(center.getLicense()) %>">&nbsp;<span id="phoneTag"></span></td>
                            </tr>
                             <tr>
                                <th width="150px"><i class="require-red"></i>推荐人编号：</th>
                                <td><input type="text" name="refereeId"
							id="refereeId" value="<%=StringUtil.notNull(center.getRefereeId()) %>">&nbsp;</td>
                            </tr>
                              <tr>
                                <th width="150px"><i class="require-red"></i>推荐人姓名：</th>
                                <td><input type="text" name="refereeName"
							id="refereeName" value="<%=StringUtil.notNull(center.getRefereeName()) %>">&nbsp;</td>
                            </tr>
                             <tr>
                                <tr>
                                <th></th>
                                <td>
                                    ...
                                    &nbsp;
                                    <input id="sbtn" class="btn btn-info" value="返回" type="button" onclick="javascript:history.go(-1);"/>
                                </td>
                            </tr>
                        </tbody></table>
                </form>
