...
<body>
		...
		<div class="main-wrap">
			...
			<div class="result-title">
					<div class="result-list">
						<a href="admin/OrderServlet.do?method=admin_order_confirm_ylist"><i
							class="icon-font">&#xe05b;</i>查看确认列表</a>
					</div>
				</div>
 ...
 <td><a href="admin/OrderServlet.do?method=admin_order_detail_confirm&id=<%=order.getOrderId()%>">详情</a>&nbsp;|&nbsp;<a href="admin/OrderServlet.do?method=admin_order_adr_edit&id=<%=order.getOrderId()%>">修改收货地址</a></td>
 </tr>
	 	<%}}
