...
$(function() {
	...
	$("#type").change(function() {
		$.ajax({
				type : "post",
				url : "admin/ParamServlet.do?method=checkParamType",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				param : {//设置数据源
	...
	$("#sbtn").click(function(){
		...
		if(errorstr!=""){
			...
			$('#myform').attr("action", "admin/ParamServlet.do?method=update");
	       	$('#myform').submit();
       		 return ture;
