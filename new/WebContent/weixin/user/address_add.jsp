...
<div class="content">
	<div class="header">
        ...
        <p class="go-title-ch">
        	添加地址</p><p class="go-title-en">ADD ADDRESS
        </p>
...
<div class="content">
    ...
    <div class="container no-bottom">
            <div class="contact-form no-bottom"> 
                <form  action="AddressServlet.do?method=save"  id="myform" name="myform" method="post">
                <input type="hidden" name="token" id="token" value="<%=StringUtil.notNull(token)%>"/> 
                    <fieldset>
                       
                         <div>
                            <label>收件人： &nbsp;&nbsp;<span id="nameTag"></span></label>
                            <input type="text" name="receiver" value="" class="contactField" id="receiver"/>
                        </div>
                        <div>
