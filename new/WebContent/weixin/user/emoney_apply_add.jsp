...
<div class="content">
    ...
    <div class="container no-bottom">
            <div class="contact-form no-bottom"> 
                <form action="ChargeApplyServlet.do?method=apply_save" method="post" class="contactForm" id="myform">
                <input type="hidden" name="token" id="token" value="<%=StringUtil.notNull(token)%>"/> 
                    <fieldset>
                         <div>
                            <label>充值金额：&nbsp;&nbsp;<span id="amountTag"></span></label>
                          ...
                          <div>
                            <label>转入账号：&nbsp; &nbsp;<span id="accountTag"></span></label>
                          
                            <select name="accountId" id="accountId" class="contactField">
                     	 ...
                     	 <div>
							<label>备注说明：&nbsp;&nbsp;<span id="remarkTag"></span></label> <input type="text" name="remark" id="remark" class="contactField"> 
					 		<a>*请注明汇款账户、汇款姓名、汇款时间以便财务审核通过！</a>
							
						</div>
						 <div class="decoration"></div>
                        <div>
                            <input type="submit" class="buttonWrap button button-green contactSubmitButton" id="sbtn" value="提交" />
                        </div>
                    </fieldset>
                </form>       
            </div>
