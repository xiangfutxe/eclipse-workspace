                    ...
                    <fieldset>
                        <div class="formValidationError" id="userNameError">
                            <div class="static-notification-red tap-dismiss-notification">
                                <p class="center-text uppercase">用户名不能为空！</p>
                            </div>
                        </div>             
                        <div class="formValidationError" id="passwordError">
                            <div class="static-notification-red tap-dismiss-notification">
                                <p class="center-text uppercase">登录密码不能为空！</p>
                            </div>
                        </div> 
                       <div class="formValidationError" id="passworddError2">
                        ...
                        <div class="formFieldWrap">
                            ...
                            <input type="text" name="userId" value="" class="contactField requiredField" id="userId"/>
                        </div>
                        <div class="formFieldWrap">
                        ...
                        <div class="formSubmitButtonErrorsWrap">
                            <input type="submit" class="buttonWrap button button-green contactSubmitButton" id="submitButton" value="我要登陆" data-formId="contactForm"/>
                        </div>
                        <br>
                       <a href="UserServlet.do?method=user_vip_add"><span class="font_size_14">我要注册</span></a>
