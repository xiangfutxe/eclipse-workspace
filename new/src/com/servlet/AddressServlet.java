...
public class AddressServlet extends HttpServlet {
	...
	public void list(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
		...
		try {
			...
			if(db.createConn()){
				String sql = "select * from address  where state='1' and user_id='"+user.getUserId()+"'order by id desc";
	...
	public void update(HttpServletRequest request,HttpServletResponse response) throws ServletException, IOException{
		...
		try {
			...
			if(db.createConn()){
				...
				rs =stmt.executeQuery(sql);
				if(rs.next()){
					String sqlu= "update address set receiver='"+receiver+"',address='"+adr+"',phone='"+phone+"',province='"+province+"',city='"+city+"',area='"+area+"',end_time='"+date+"' where id='"+id+"'";
		...
		try {
			...
			if(db.createConn()){
				 ...
				 conn.setAutoCommit(false);
					 ...
					 java.sql.Timestamp date = new java.sql.Timestamp(date1.getTime());
					 stmt = conn.createStatement();
					 String sqli = "insert into address(user_id,receiver,phone,province,city,area,address,tag,state,entry_time,end_time) values('"+user.getUserId()
