			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.action">首页</a><span
						...
						<span
						class="crumb-step">&gt;</span><span>盘盈审核</span><span
...
$(function() {
	...
	$("#ybtn").click(function(){
		if (!confirm("确认通过？")) {
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_in_4_review_yes");
	...
	$("#nbtn").click(function(){
		if (!confirm("确认不通过，不通过入库单将退回上一步流程？")) {
								return false;
											...
											$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_in_4_review_no");
	...
	$("#b_btn").click(function(){
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_in_4_review");
       		 $('#cfmform').submit();
       		 return true;
	});
	});
