  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span><span>入库仓管确认</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/InventoryServlet.do?method=apply_in_cfm_update" method="post" id="myform" name="myform">
...
<%=StringUtil.notNull(ivy.getApplyId()) %>                                </td>
                             ...
                             <tr>
                                <th><i class="require-red">*</i>采购单价:</th>
                                <td>
