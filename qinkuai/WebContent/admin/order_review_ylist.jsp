		...
		<div class="main-wrap">
			...
			<div class="search-wrap">
				<div class="search-content">
					<form action="admin/OrderServlet.do?method=admin_order_review_ylist" id="searchForm" method="post">
					...
					<option value="">--请选择订单类型--</option>
						...
						</select>&nbsp;分店编号：<input class="common-text" name="userId" id="userId" size="15"
