		...
		<div class="main-wrap">
			<div class="crumb-wrap">
				<div class="crumb-list">
					...
					<span class="crumb-step">&gt;</span><span class="crumb-name">出库查询</span>
				</div>
			</div>
					...
					<table class="result-tab" width="100%">
						...
						if(pager!=null){
							...
							<tr>
								...
								<td><%if(apply.getState()==1){%>数据录入中<%}else if(apply.getState()==2) {%>待质检验收<%}else if(apply.getState()==3) {%>待仓管确认<%}else if(apply.getState()==4) { %>待财务审核<%}else if(apply.getState()==5) { %>财务已审核<%} %></td>
