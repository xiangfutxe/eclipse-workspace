...
<body>
				...
				<div class="result-content">
					<table class="result-tab" width="99%">
						<tr>
							...
							<th>订单类型</th><th>总金额</th><th>分店信息</th><th>收件人</th><th>联系电话</th><th>订单日期</th><th>当前状态</th><th>操作</th>
 ...
 <td><a href="admin/OrderServlet.do?method=admin_order_detail&id=<%=order.getOrderId()%>">详情</a>
 |<a href="admin/OrderServlet.do?method=admin_delivery_list&id=<%=order.getOrderId()%>">配货单</a></td>
 </tr>
	 	<%}}
