...
InventoryDetail ivy = (InventoryDetail)request.getAttribute("sys_ivd");
  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span><span>出库仓管确认</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/InventoryServlet.do?method=apply_out_cfm_update" method="post" id="myform" name="myform">
                 <input type="hidden" name="token" id="token" value="<%=StringUtil.notNull(token)%>"/> 
                                     <input type="hidden" name="id" id="id" value="<%=ivy.getId()%>"/> 
                    
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th width="150px"><i class="require-red">*</i>出库单号：</th>
                                <td>
<%=StringUtil.notNull(ivy.getApplyId()) %>                                </td>
                             ...
                             <tr>
                                ...
                                <td>
								<%=StringUtil.notNull(ivy.getProductId()) %>                              </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>单价:</th>
                                <td>
									<input type="text" id="price" name="price" value="<%=ivy.getPrice() %>" />
							  </td>
                            </tr>
