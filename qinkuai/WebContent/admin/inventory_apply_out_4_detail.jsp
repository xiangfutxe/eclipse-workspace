			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.action">首页</a><span
						...
						<span
						class="crumb-step">&gt;</span><span>盘亏出库</span><span
						class="crumb-step">&gt;</span><span class="crumb-name">出库单</span>
				</div>
			</div>
			...
			<div class="result-wrap">
					  ...
					  <td> <%=StringUtil.notNull(p.getUnit())%></td>
					   <td> <%=StringUtil.decimalFormat(p.getNum())%></td>
						...
						<td><%=StringUtil.notNull(p.getRemark()) %></td>
						 <%if(ap.getState()==1){ %>
						 <td><a href="admin/InventoryServlet.do?method=apply_out_4_pro_del&id=<%=p.getId() %>">删除</a>
						 <%} %>
							</tr>
					<%}
					if(coll.size()<6){
				...
				<p>&nbsp;</p>
				 <div class="result-list">
				 	<form action="admin/InventoryServlet.do?method=apply_out_4_pro_cfm" id="cfmform" method="post">
...
<p>&nbsp;</p>
				...
				<div class="result-content">
									<form action="admin/InventoryServlet.do?method=apply_out_4_pro_add" id="addform" method="post">
...
$(function() {
	...
	$("#b_btn").click(function(){
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_4");
       		 $('#cfmform').submit();
       		 return true;
	});
	});
