...
<body>
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.jsp">首页</a><span
						...
						<span class="crumb-step">&gt;</span><span>订单支付</span>
				</div>
			</div>
			<div class="result-wrap">
				<form method="post" id="myform" name="myform">
				<input type="hidden" id="id" name="id" value="<%=orders.getOrderId() %>"/>
 ...
 <tr <%if(t%2==1){%>class="even"<%}%>>
					...
					<div class="result-title">
						...
						&nbsp;<%if(orders.getTag()==0){ %><input type="button" class="btn" id="sbtn1" value="确认支付"/><%} %></p>
						</div>
					</div>
				</form>
			</div>
	...
	$(document).ready(function() {
		$("#sbtn1").bind("click", function() {
			...
			return false;
			 	...
			 	$('#myform').attr("action", "admin/OrderServlet.do?method=admin_order_payoff_yes");
	       		$('#myform').submit();
				return true;
			}
		});
