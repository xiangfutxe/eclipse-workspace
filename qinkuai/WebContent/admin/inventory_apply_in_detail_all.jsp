			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.action">首页</a><span
						...
						<span
						class="crumb-step">&gt;</span><span>入库查询</span><span
				...
				<form  id="cfmform" method="post">
				 ...
				 <div class="result-list">
                     ...
                     <table class="search-tab">
                        <tr>
                            <td>
                   <button class="btn" id="b_btn"><i class="icon-font">&#xe046;</i>返回入库查询</button>&nbsp;
                   </td>
                     </tr>
                     </table>
...
$(function() {
	...
	$("#b_btn").click(function(){
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_in_all");
       		 $('#cfmform').submit();
       		 return true;
	});
	});
