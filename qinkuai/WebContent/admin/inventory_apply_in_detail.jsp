			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.action">首页</a><span
						...
						<span
						class="crumb-step">&gt;</span><span>入库申请</span><span
			...
			<div class="result-wrap">
					  ...
					  <td> <%=StringUtil.notNull(p.getUnit())%></td>
					   <td> <%=StringUtil.decimalFormat(p.getNum())%></td>
						...
						<td><%=StringUtil.notNull(p.getRemark()) %></td>
						 <%if(ap.getState()==1){ %>
						 <td><a href="admin/InventoryServlet.do?method=apply_in_pro_del&id=<%=p.getId() %>">删除</a>
						 <%} %>
							</tr>
					<%}
					if(coll.size()<6){
				...
				<p>&nbsp;</p>
				 <div class="result-list">
				 	<form action="admin/InventoryServlet.do?method=apply_in_pro_cfm" id="cfmform" method="post">
...
<p>&nbsp;</p>
				...
				<div class="result-content">
									<form action="admin/InventoryServlet.do?method=apply_in_pro_add" id="addform" method="post">
                      ...
                      <%if(ap.getType()==1){ %>
                       <tr>
                          ...
                          金额：
                   			 ...
                   			 <td>
                         <input type="text" name="price" id="price"/><span id="priceTag"></span>
                   			</td>
                     </tr>
                     <%}else{ %>
...
$(function() {
	...
	$("#b_btn").click(function(){
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_in");
       		 $('#cfmform').submit();
       		 return true;
	});
	});
