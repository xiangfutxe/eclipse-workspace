			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					...
					<span class="crumb-step">&gt;</span><span>仓库管理</span><span
						class="crumb-step">&gt;</span><span>出库质检验收</span><span
			...
			<div class="result-wrap">
				...
				<p>&nbsp;</p>
				 ...
				 <input type="hidden" name="id" id="id" value="<%=ap.getApplyId()%>"/>
                  ...
                  <%} %>
                   <button class="btn" id="b_btn"><i class="icon-font">&#xe046;</i>返回验收列表</button>&nbsp;
                   </td>
                     </tr>
                     </table>
                     </form>
...
$(function() {
	...
	$("#ybtn").click(function(){
		if (!confirm("确认通过验收？")) {
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_check_yes");
	...
	$("#nbtn").click(function(){
		if (!confirm("确认验收不通过，不通过出库单将退回上一步流程？")) {
								return false;
							} else {
											$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_check_no");
	...
	$("#b_btn").click(function(){
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_check");
       		 $('#cfmform').submit();
       		 return true;
	});
	});
