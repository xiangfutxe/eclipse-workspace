	...
	$("#abtn").click(function(){
		if (!confirm("确认提交申请？")) {
        	...
        	if($("#supplier").val()==""){
 			...
 			if(error==""){
         		$('#saveform').attr("action", "admin/PurchaseApplyServlet.do?method=admin_apply_save");
       		 	$('#saveform').submit();
       		 	return true;
       		 }else{
  ...
  <div class="container clearfix">
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">采购管理</span>
             <span class="crumb-step">&gt;</span><span class="crumb-name">采购申请</span>
             <span class="crumb-step">&gt;</span><span class="crumb-name">新增申请</span>
             </div>
        </div>
       
        <div class="result-wrap">
           <form action="admin/PurchaseApplyServlet.do?method=admin_apply_save" method="post" id="saveform" name="saveform">
