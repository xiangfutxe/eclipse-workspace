...
double[] sum = (double[])request.getAttribute("sum");
	...
	String[][] rankstr = StringUtil.getRankStr(admin.getRank());
		if(rankstr[6][14].equals("1")||admin.getState().equals("1")){
						...
						<table class="search-tab">
							<tr>
								...
								<td><select class="common-text" id="type" name="type">
									...
									<option value="1"
											<%if(StringUtil.notNull(type).equals("1")){%>selected<%} %>>--现金账户--</option>
									...
									<option value="汇款充值"
										...
										<option value="现金充值"
											...
											<option value="充值撤回"
											<%if(StringUtil.notNull(tradeType).equals("充值撤回")){%>selected<%} %>>--充值撤回--</option>
										<option value="消费购物"
											<%if(StringUtil.notNull(tradeType).equals("消费购物")){%>selected<%} %>>--消费购物--</option>
											<option value="购物退回"
											<%if(StringUtil.notNull(tradeType).equals("购物退回")){%>selected<%} %>>--购物退回--</option>
											<option value="账户增扣"
											<%if(StringUtil.notNull(tradeType).equals("账户增扣")){%>selected<%} %>>--账户增扣--</option>
