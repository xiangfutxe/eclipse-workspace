...
<body>
			...
			<div class="search-wrap">
				<div class="search-content">
					<form action="admin/OrderServlet.do?method=admin_orders" id="searchForm"
						...
						<td><select name="state" id="state" class="common-text">
			...
			<div class="result-wrap">
				...
				<div class="result-title">
					<div class="result-list">
						<a href="admin/OrderServlet.do?method=admin_order_new_branch_shop_add"><i
							class="icon-font">&#xe026;</i>新增配货</a>
					</div>
				</div>
				<div class="result-content">
					<table class="result-tab" width="97%">
						<tr>
							...
							<th>订单编号</th><th>总金额</th><th>店铺信息</th><th>收件人</th><th>联系电话</th><th>订单日期</th><th>当前状态</th><th>操作</th>
 ...
 <td><%if(order.getState()==1){%>待确认<%}else if(order.getState()==2){%>待发货<%}else if(order.getState()==3){%>出库中<%}else if(order.getState()==4){%>已发货<%}else if(order.getState()==0){%>已退订<%} %></td>
