		...
		<div class="main-wrap">
			<div class="crumb-wrap">
				<div class="crumb-list">
					...
					<span class="crumb-step">&gt;</span><span>仓库管理</span><span
						class="crumb-step">&gt;</span><span>出库财务审核</span><span
...
$(function() {
	...
	$("#ybtn").click(function(){
		if (!confirm("确认审核通过？")) {
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_review_yes");
	...
	$("#nbtn").click(function(){
		if (!confirm("确认审核不通过，不通过出库单将退回上一步流程？")) {
								return false;
							} else {
											$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_review_add");
	...
	$("#b_btn").click(function(){
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_review");
       		 $('#cfmform').submit();
       		 return true;
	});
	});
