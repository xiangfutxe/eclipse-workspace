			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.jsp">首页</a><span
						...
						<span
						class="crumb-step">&gt;</span><span>盘亏审核</span><span
			...
			<div class="result-wrap">
				...
				<p>&nbsp;</p>
				 ...
				 <input type="hidden" name="id" id="id" value="<%=ap.getApplyId()%>"/>
                  ...
                  <%}%>
                   <button class="btn" id="b_btn" ><i class="icon-font">&#xe046;</i>返回复核列表</button>&nbsp;
                   </td>
                     </tr>
                     </table>
                     </form>
...
$(function() {
	...
	$("#ybtn").click(function(){
		if (!confirm("确认通过？")) {
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_4_review_yes");
	...
	$("#nbtn").click(function(){
		if (!confirm("确认不通过，不通过出库单将退回上一步流程？")) {
								return false;
											...
											$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_4_review_no");
	...
	$("#b_btn").click(function(){
				...
				$('#cfmform').attr("action","admin/InventoryServlet.do?method=apply_out_4_review");
       		 $('#cfmform').submit();
       		 return true;
	});
	});
