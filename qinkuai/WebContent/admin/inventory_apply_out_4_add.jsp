	...
	$("#abtn").click(function(){
		if (!confirm("确认提交申请？")) {
        	...
        	if($("#supplier").val()==""){
 			...
 			if(error==""){
         		$('#saveform').attr("action", "admin/InventoryServlet.do?method=apply_out_4_save");
       		 	$('#saveform').submit();
       		 	return true;
       		 }else{
  ...
  <div class="container clearfix">
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span><span class="crumb-name">新增出库</span></div>
        </div>
       
        <div class="result-wrap">
           <form action="admin/InventoryServlet.do?method=apply_out_4_save" method="post" id="saveform" name="saveform">
