...
PurchaseApply ivy = (PurchaseApply)request.getAttribute("sys_ivy");
  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span>采购管理<span class="crumb-step">&gt;</span><span>采购审批</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/PurchaseApplyServlet.do?method=admin_review_no" method="post" id="myform" name="myform">
                 <input type="hidden" name="token" id="token" value="<%=StringUtil.notNull(token)%>"/> 
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th width="150px"><i class="require-red">*</i>采购单号：</th>
                                <td>
