  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span>会员管理<span class="crumb-step">&gt;</span><span>服务中心</span><span class="crumb-step">&gt;</span><span>服务店类型</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                   <form action="admin/CenterServlet.do?method=admin_up_save" method="post" id="myform" name="myform">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th width="150px"><i class="require-red">*</i>最新类型：</th>
                                <td><select id="typeNew" name="typeNew">
                                <option value="1">社区店</option>
								<option value="2" >中心店</option>
								</select>&nbsp;<span id="typeNewTag"></span></td>
                            </tr>
                             <tr>
                                <tr>
                                <th></th>
