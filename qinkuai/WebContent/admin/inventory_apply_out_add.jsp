	...
	$("#abtn").click(function(){
		if (!confirm("确认提交申请？")) {
        	...
        	if($("#supplier").val()==""){
 			...
 			if(error==""){
         		$('#saveform').attr("action", "admin/InventoryServlet.do?method=apply_out_save");
       		 	$('#saveform').submit();
       		 	return true;
       		 }else{
  ...
  <div class="container clearfix">
   <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span><span>仓库管理</span><span class="crumb-step">&gt;</span><span class="crumb-name">出库申请</span><span class="crumb-step">&gt;</span><span class="crumb-name">新增出库</span></div>
        </div>
       
        <div class="result-wrap">
           <form action="admin/InventoryServlet.do?method=apply_out_save" method="post" id="saveform" name="saveform">
...
<%}}%>
                             ...
                             <tr>
                                ...
                                <td>
									...
									<option value='3'>损耗出库</option>
									<option value='4'>外销出库</option>
									<option value='5'>体验出库</option>
									<option value='6'>赠送出库</option>
									<option value='7'>研发出库</option>
									<option value='8'>退货出库</option>
									<option value='9'>展销出库</option>
									</select>
									                                </td>
                            </tr>
                             <tr>
