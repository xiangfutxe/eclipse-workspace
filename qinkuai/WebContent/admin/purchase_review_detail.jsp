			...
			<div class="result-wrap">
				...
				<p>&nbsp;</p>
				 ...
				 <input type="hidden" name="id" id="id" value="<%=ap.getApplyId()%>"/>
                   ...
                   <button class="btn" id="b_btn"><i class="icon-font">&#xe046;</i>返回采购审批</button>&nbsp;
                     <%if(ap.getState()==2){ %>
                            <button class="btn btn-info" id="ybtn"><i class="icon-font">&#xe025;</i>审批通过</button>&nbsp;
                            <button class="btn btn-warning" id="nbtn"><i class="icon-font">&#xe024;</i>审批不通过</button>&nbsp;
...
$(function() {
	...
	$("#b_btn").click(function(){
				...
				$('#cfmform').attr("action","admin/PurchaseApplyServlet.do?method=admin_apply_review_list");
       		 $('#cfmform').submit();
       		 return true;
	});
	});
