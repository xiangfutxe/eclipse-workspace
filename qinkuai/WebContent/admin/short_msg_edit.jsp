...
ShortMessage sm = (ShortMessage) request.getAttribute("sys_short_msg");
if(admin==null) {
out.println("<script>");
  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
             ...
             <span class="crumb-step">&gt;</span>信息管理
             <span class="crumb-step">&gt;</span><span>短信模板</span>
             <span class="crumb-step">&gt;</span><span>修改模板</span>
			</div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/ShortMessageServlet.do?method=admin_update" method="post" id="myform" name="myform">
                  <input type="hidden" name="token" id="token" value="<%=StringUtil.notNull(token)%>"/>
                                 <input type="hidden" id="id" name="id" value='<%=sm.getId()%>'/>
                    <table class="insert-tab" width="100%">
                        <tbody>
						 <tr>
                                <th><i class="require-red">*</i>短信类型：	
                              
                                </th>
                                <td><input class="common-text" name="type" id="type" type="text" size="50" value='<%=StringUtil.notNull(sm.getType())%>'>&nbsp;<span id="typeTag"></span></td>
                            </tr>
						<tr>
						<tr>
                                <th><i class="require-red">*</i>手机号码：	
                              
                                </th>
                                <td><input class="common-text" name="tel" id="tel" type="text" size="50" value='<%=StringUtil.notNull(sm.getTel())%>'>&nbsp;<span id="telTag"></span>
                                <br>如果需要输入多个手机号码，以“,"隔开。</td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>短信内容：</th>
                                 <td><textarea id="shortMsg" name="shortMsg" style="width:400px;height:200px;"><%=StringUtil.notNull(sm.getShortMsg())%></textarea><span id="msgTag"></span>
