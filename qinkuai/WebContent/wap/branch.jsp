...
<div class = "tb_box">
     ...
     <%if(plist!=null){
    		...
    		%>
		            <li class="b-list">
			                <div class="b-info">
			                    <p><span  class="b-title"><%=plist.get(i).getProvince()%>[<%=plist.get(i).getCity()%>]</span> 
			                    <span class="b-attr"> 有<%=plist.get(i).getTag()%>家门店</span>
			                    <a href="BranchServlet.do?method=branch_detail&province=<%=plist.get(i).getProvince()%>&city=<%=plist.get(i).getCity()%>"><span class="b-right"><img src="images/right-tag.png" style="width:15px;height:15px"/></span></a> 
			                    </p>
			                </div>
