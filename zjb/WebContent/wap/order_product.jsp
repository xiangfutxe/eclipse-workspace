	    	 ...
	    	 %>
			    	<li>
			    		...
			    		<div class="shop-list-mid">
		                	<div class="tit"><%=p.getProductName() %></div>
		                ...
		                <div class="list-cart">
		                    ...
		                    <a  href="OrderServlet?method=disDe_p&id=<%=p.getId()%>&idstr=<%=idstr%>" class="btn btn-default"><span class="glyphicon glyphicon-minus gary"></span></a>
		                    <input type="tel" class="btn gary2 Amount" readonly="readonly" value="<%=p.getNum() %>" maxlength="4">
		                    <a  href="OrderServlet?method=increate_p&id=<%=p.getId()%>&idstr=<%=idstr%>" class="btn btn-default"><span class="glyphicon glyphicon-plus gary"></span></a>
