...
<div class="container" >
	 <div class="row rowcar">
	 	<form id="myform" action="login.do" class="login" method="post">
		<div class="tab">
		<ul class="tab-hd"><li class="active">账号密码登陆</li><li>手机快捷登陆</li>
		</ul>
		<ul class="tab-bd"><li class="thisclass">
			<div class="login">
			<div class="li"><img src="images/login_user.png" alt=""><input type="text" value="" name="nickName" id="nickName" placeholder="请输入用户名">
			</div>
			<div class="li"><img src="images/login_psw.png" alt=""><input type="text" value="" name="password" id="password"  placeholder="请输入登陆密码">
			</div>
			<div class="li"><img src="images/login_code.png" alt=""><input type="text" value="" name="code" id="code" placeholder="请输入验证码"><span id="checkCode" onclick="createCode()"></span>
			</div>
