...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
     ...
     <form action="JobServlet?method=updateJob" id="myform" method="post">
    ...
    <input name="name" id="name" type="text" class="dfinput" value="${job.name}" /><i id="nameTag1"></i><i id="nameTag"></i></li>
    <li><label>职务描述<b>*</b></label><input name="remark" id="remark" type="text" class="dfinput"  value="${job.remark}" /><i id="remarkTag"></i></li>
    <li><label>&nbsp;</label>
    <%if(ranks[9][12].equals("1")||admin.getState()-1==0){ %>
...
$(function() {
  ...
  $("#name").blur(function() {
		$.ajax({
				type : "post",
				url : "JobServlet?method=isJobExitUpdate",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
					name : $("#name").val()
