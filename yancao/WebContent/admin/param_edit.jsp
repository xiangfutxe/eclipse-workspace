...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
     ...
     <form action="ParamServlet?method=update" id="myform" method="post">
         <input type="hidden" name="token" id="token" value="${sessionScope.token}"/>
          <input type="hidden" name="id" id="id" value="<%=param.getId()%>"/>
    <ul class="forminfo">
    <li><label>参数名称<b>*</b></label>
    <input name="paramName" id="paramName" type="text" class="dfinput" value="<%=param.getParamName() %>" readonly="readonly"/><i id="nameTag1"></i><i id="nameTag"></i></li>
   <li><label>参数1<b>*</b></label>
    <input name="amount_1" id="amount_1" type="text" class="dfinput" value="<%=param.getAmount_1() %>"/><i id="amount_1Tag"></i></li>
       <li><label>参数2<b>*</b></label>
    <input name="amount_2" id="amount_2" type="text" class="dfinput" value="<%=param.getAmount_2() %>"/><i id="amount_2Tag"></i></li>
       <li><label>参数3<b>*</b></label>
    <input name="amount_3" id="amount_3" type="text" class="dfinput" value="<%=param.getAmount_3() %>"/><i id="amount_3Tag"></i></li>
       <li><label>参数4<b>*</b></label>
    <input name="amount_4" id="amount_4" type="text" class="dfinput" value="<%=param.getAmount_4() %>"/><i id="amount_4Tag"></i></li>
       <li><label>参数5<b>*</b></label>
    <input name="amount_5" id="amount_5" type="text" class="dfinput" value="<%=param.getAmount_5() %>"/><i id="amount_5Tag"></i></li>
       <li><label>参数6<b>*</b></label>
    <input name="amount_6" id="amount_6" type="text" class="dfinput" value="<%=param.getAmount_6() %>"/><i id="amount_6Tag"></i></li>
       <li><label>参数7<b>*</b></label>
    <input name="amount_7" id="amount_7" type="text" class="dfinput" value="<%=param.getAmount_7() %>"/><i id="amount_7Tag"></i></li>
       <li><label>参数8<b>*</b></label>
    <input name="amount_8" id="amount_8" type="text" class="dfinput" value="<%=param.getAmount_8() %>"/><i id="amount_8Tag"></i></li>
       <li><label>参数9<b>*</b></label>
    <input name="amount_9" id="amount_9" type="text" class="dfinput" value="<%=param.getAmount_9() %>"/><i id="amount_9Tag"></i></li>
       <li><label>参数10<b>*</b></label>
    <input name="amount_10" id="amount_10" type="text" class="dfinput" value="<%=param.getAmount_10() %>"/><i id="amount_10Tag"></i></li>
       <li><label>单位<b></b></label>
    <input name="unit" id="unit" type="text" class="dfinput" value="<%=param.getUnit() %>"/><i id="unitTag"></i></li>
...
$(function() {
	...
	$("#paramName").blur(function() {
		$.ajax({
				type : "post",
				url : "ParamServlet?method=isExitUpdate",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
