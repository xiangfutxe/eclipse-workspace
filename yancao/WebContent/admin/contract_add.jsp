...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
     ...
     <form action="ContractServlet?method=save" id="myform" method="post">
    ...
    <ul class="forminfo">
     ...
     <option value="0">--请选择密级--</option>
      <option value="1">--保密--</option>
       <option value="2">--可公开--</option>
     </select>
     </li>
     <li><label>合同编号<b>*</b></label>
    <input name="contractId" id="contractId" type="text" class="dfinput" /><i id="contractIdTag"></i><i id="contractIdTag1"></i></li>
    
         <li><label>合同名称<b>*</b></label>
    <input name="contractName" id="contractName" type="text" class="dfinput" /><i id="contractNameTag"></i></li>
    <li><label>承办人<b>*</b></label><input name="adminName" id="adminName" type="text" class="dfinput" value="<%=admin.getAdminName() %>" />
    <input name="adminId" id="adminId" type="hidden" class="dfinput" /><i id="adminNameTag"></i><i id="adminNameTag1"></i></li>
    <li><label>合同位置<b>*</b></label><input name="code" id="code" type="text" class="dfinput" /><i id="codeTag"></i></li>
    <li><label>合同甲方<b>*</b></label><input name="partyA" id="partyA" type="text" class="dfinput" /><i id="partyATag"></i></li>
     <li><label>合同乙方<b>*</b></label><input name="partyB" id="partyB" type="text" class="dfinput" /><i id="partyBTag"></i></li>
     <li><label>签订时间<b>*</b></label><input name="startTime" id="startTime" type="text" class="dfinput" onfocus="new Calendar().show(this);"/><i id="startTimeTag"></i></li>
       <li><label>结束时间<b>*</b></label><input name="endTime" id="endTime" type="text" class="dfinput" onfocus="new Calendar().show(this);"/><i id="endTimeTag"></i></li>
