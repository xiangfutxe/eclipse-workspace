...
if (admin == null) {
 ...
 String[][] ranks = StringUtil.getRankStr(admin.getRank());
	if(ranks[0][0].equals("1")||admin.getState()-1==0){
	%>
...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
     ...
     <form action="NewsServlet?method=save" id="myform" method="post">
    <ul class="forminfo">
    <li><label>新闻标题<b>*</b></label><input type="hidden" name="token" id="token" value="${sessionScope.token}"/>
    <input name="title" id="title" type="text" class="dfinput" /><i id="titleTag"></i></li>
    <li><label>新闻来源<b>*</b></label><input name="source" id="source" type="text" class="dfinput" /><i id="sourceTag"></i></li>
    <li><label>新闻类型<b>*</b></label>
     <div class="vocation">  <select name="sort" id="sort" class="select1"> <option value="公司动态" >公司动态</option>
     <option value="行业动态">行业动态</option></select>
     </div><i id="typeTag"></i>
     </li>
    <li><label>新闻正文<b>*</b></label><textarea id="editor_id" name="contents" style="width:700px;height:250px;visibility:hidden;"></textarea><i id="contentsTag"></i></li>
