...
<body>
    ...
    <div class="formtitle"><span>基本信息</span></div>
     ...
     <form action="ModuleServlet?method=save" id="myform" method="post">
     <input type="hidden" name="token" id="token" value="${sessionScope.token}"/>
    <ul class="forminfo">
     <li><label>模块编号<b>*</b></label>
    <input name="code" id="code" type="text" class="dfinput" /><i id="codeTag"></i></li>
    <li><label>模块标题<b>*</b></label>
    <input name="title" id="title" type="text" class="dfinput" /><i id="titleTag"></i></li>
  
    <li><label>模块正文<b>*</b></label><textarea id="editor_id" name="contents" style="width:700px;height:250px;visibility:hidden;"></textarea><i id="contentsTag"></i></li>
