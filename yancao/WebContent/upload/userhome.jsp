...
<div class="maincontainer" style="max-width:768px;margin:0 auto;">
		...
		<div class="list-group pt10">
			<a href="code.jsp" class="list-group-item tip">
				<span class="item_img">
						<img src="images/user_order_1.png"></span>
						<span class="left-label">我的推荐</span>
				<span class="gary pull-right pr15 pt2" >二维码</span>
			</a>
			<a href="UserServlet?method=users_detail" class="list-group-item tip">
				<span class="item_img">
						<img src="images/user_order_1.png"></span>
			...
			<span class="item_img">
						<img src="images/user_order_2.png"></span>
				<span class="left-label">我的库存</span>
			</a>
		</div>
		...
		<div class="list-group pt10">
			...
			<span class="item_img">
				...
				<span class="left-label">地址管理</span>
				<span class="gary pull-right pr15 pt2">问题咨询、反馈等</span>
			</a>
			<a href="UserServlet?method=psw_edit" class="list-group-item tip">
			<em class="item_img">
						<img src="images/user_order_4.png"></em>
				<span class="left-label">密码修改</span>
				<span class="gary pull-right pr15 pt2">修改登密码</span>
			</a>
		</div>
		
		<div class="list-group pt10">
			<a href="UserServlet?method=login_out" class="list-group-item tip">
			<span class="item_img">
