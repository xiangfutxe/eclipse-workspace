...
<div class="main_bg">
	...
	<div class="second">   
        	...
        	<div class="scd_ml">
            	<ul class="sidenav">
          		 <li><a href="UserServlet?method=user_detail">个人资料</a></li>
                    ...
                    <li   class="now"><a href="ReportServlet?method=report_settle_day">已结业绩</a></li>
		...
		<div class="content content-full-width" id="content-all">
                	<div class="notice">
         <h2>已结业绩</h2><span class="required_notification"></span>
   </div>
			 <div class="p-li">
			<table class="result-tab" width="100%">
						<thead><tr>
						<th>起始时间</th><th>当前级别</th><th>区域<br>总累计</th><th>期初<br>累计</th><th>区域<br>新增业绩</th><th>A区<br>新增业绩</th><th>A区<br>盈余</th><th>B区<br>新增业绩</th><th>B区<br>盈余</th><th>销售<br>新增业绩</th><th>销售<br>期初累计</th><th>销售<br>总累计</th>
						</tr>
						<%
						List<DSettle> wlist = (List<DSettle>) request.getAttribute("wstlist");
						if(wlist!=null&&wlist.size()>0){ 
							for(int i=0;i<wlist.size();i++){
							DSettle w = wlist.get(i);
							if(w.getState()>1){
						%>
						<tr>
