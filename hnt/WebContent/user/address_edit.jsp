...
<div class="main_bg">
	...
	<div class="second">   
        <div class="scd_m clearfix">
		 ...
		 <div class="scd_mr">
            	<div class="ht_table">
            	<h2>当前位置：业务管理-&gt;地址管理-&gt;<a>修改地址</a></h2>
            	</div>
            		<div class="content content-full-width">
    <form  action="AddressServlet?method=update"  id="myform" name="myform" method="post">
         ...
         <h2>新增收货地址</h2><span class="required_notification">* 表示必填项</span>
  			 ...
  			 <td ><input id="receiver" name="receiver"  type="text" value="<%=StringUtil.notNull(adr.getReceiver())%>">&nbsp;<span id="nameTag"></span></td>
  			 </tr>
  			  <tr>
  			 ...
  			 <td ><input  type="text"  name="address"  id="address" value="<%=StringUtil.notNull(adr.getAddress())%>">&nbsp;<span id="addressTag" ></span></td>
  			 </tr>
  			 <tr>
  			 <td><label><span class="required">*</span>联系电话：</label></td>
  			 <td ><input  type="text" name="phone" id="phone" value="<%=StringUtil.notNull(adr.getPhone())%>">&nbsp;<span id="phoneTag"></span></td>
  			 </tr>
...
$(function() {
 ...
 $("#city_2").citySelect({
   ...
   $("#address").blur(function(){
   		 if($(this).val()=="")  $("#addressTag").text("收获地址不能为空！").css({"color":"red","font-size":"12px"}); 
