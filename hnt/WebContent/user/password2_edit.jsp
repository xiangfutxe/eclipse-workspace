...
<div class="main_bg">
	...
	<div class="second">   
		...
		<div class="notice">
         ...
         <form  action="UserServlet?method=user_password2_update"  id="myform" name="myform" method="post">
		
                	<div class="notice">
         <h2>支付密码修改</h2><span class="required_notification"></span>
   </div>
