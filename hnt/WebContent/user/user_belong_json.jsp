  ...
  <script type="text/javascript" src="../ztree/js/jquery.ztree.core.js"></script>
	<SCRIPT type="text/javascript">
        var setting = {  
                ...
                async: {
                    enable: true,
                    url:"UserServlet?method=belongJson",
        ...
        <div class="scd_m clearfix">
        	<div class="scd_ml">
            	<ul class="sidenav">
                    ...
                    <li  class="now"><a href="UserServlet?method=getBelong">销售关系</a></li>
         ...
         <h2>支付密码</h2><span class="required_notification"></span>
         	 ...
         	 <table class ="form-table">
  			 ...
  			 <td ><input id="psw2" name="psw2"  type="password" value="<%=psw2%>"/>&nbsp;<span id="psw2Tag"></span></td>
                	...
                	<div class="notice">
         <h2>销售关系</h2><span class="required_notification"></span>
   </div>
  <div class="p-li">
   <div class="form-table-one">
   <form name="serchFrom" action="UserServlet?method=getBelong" method="post">
