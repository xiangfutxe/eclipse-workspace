	...
	<div class="second">   
        <div class="scd_m clearfix">
         ...
         <h2>信息提示</h2><span class="required_notification"></span>
							...
							<div class="p-li">
							<span class="left"> <a href="ChargeApplyServlet?method=apply_add"> 继续充值 </a>&nbsp;或&nbsp;<a href="ChargeApplyServlet?method=apply_list">充值列表</a></span>
							</div>
  </div>
					</div>
         </div> 
