...
{
this.length=35;
this[0] = new Option("安徽省","安徽省");
this[1] = new Option("北京市","北京市");
this[2] = new Option("重庆市","重庆市");
this[3] = new Option("福建省","福建省");
this[4] = new Option("甘肃省","甘肃省");
this[5] = new Option("广东省","广东省");
this[6] = new Option("广西省","广西省");
this[7] = new Option("贵州省","贵州省");
this[8] = new Option("海南省","海南省");
this[9] = new Option("河北省","河北省");
this[10] = new Option("河南省","河南省");
this[11] = new Option("黑龙江省","黑龙江省");
this[12] = new Option("湖北省","湖北省");
this[13] = new Option("湖南省","湖南省");
this[14] = new Option("江苏省","江苏省");
this[15] = new Option("江西省","江西省");
this[16] = new Option("吉林省","吉林省");
this[17] = new Option("辽宁省","辽宁省");
this[18] = new Option("内蒙古自治区","内蒙古自治区");
this[19] = new Option("宁夏自治区","宁夏自治区");
this[20] = new Option("青海省","青海省");
this[21] = new Option("上海市","上海市");
this[22] = new Option("山东省","山东省");
this[23] = new Option("山西省","山西省");
this[24] = new Option("陕西省","陕西省");
this[25] = new Option("四川省","四川省");
this[26] = new Option("天津市","天津市");
this[27] = new Option("新疆自治区","新疆自治区");
this[28] = new Option("西藏自治区","西藏自治区");
this[29] = new Option("云南省","云南省");
this[30] = new Option("浙江省","浙江省");
this[31] = new Option("香港特区","香港特区");
this[32] = new Option("澳门特区","澳门特区");
this[33] = new Option("台湾","台湾");
this[34] = new Option("其它","其它");
return this;
}
function cityList()
{
...
this[0][1] = new Option("淮北市","淮北市");
this[0][2] = new Option("淮南市","淮南市");
this[0][3] = new Option("黄山市","黄山市");
this[0][4] = new Option("安庆市","安庆市");
this[0][5] = new Option("蚌埠市","蚌埠市");
this[0][6] = new Option("巢湖市","巢湖市");
this[0][7] = new Option("池州市","池州市");
this[0][8] = new Option("滁州市","滁州市");
this[0][9] = new Option("六安市","六安市");
this[0][10] = new Option("马鞍山市","马鞍山市");
this[0][11] = new Option("宣城市","宣城市");
this[0][12] = new Option("宿州市","宿州市");
this[0][13] = new Option("铜陵市","铜陵市");
this[0][14] = new Option("芜湖市","芜湖市");
this[0][15] = new Option("阜阳市","阜阳市");
this[0][16] = new Option("亳州市","亳州市");
...
this[4][7] = new Option("临夏回族自治州","临夏回族自治州");
...
this[20][7] = new Option("海西蒙古族藏族自治州","海西蒙古族藏族自治州");
this[21] = new Array(1);
...
this[27][2] = new Option("克孜勒苏柯尔克孜自治","克孜勒苏柯尔克孜自治");
...
this[29][9] = new Option("怒江傈僳族自治州","怒江傈僳族自治州");
...
this[31] = new Array(1);
this[31][0] = new Option("香港","香港");
this[32] = new Array(1);
this[32][0] = new Option("澳门","澳门");
this[33] = new Array(1);
this[33][0] = new Option("台湾","台湾");
this[34] = new Array(7);
this[34][0] = new Option("北美洲","北美洲"");
this[34][1] = new Option("南美洲","南美洲");
this[34][2] = new Option("大洋洲","大洋洲");
this[34][3] = new Option("欧洲","欧洲");
this[34][4] = new Option("亚洲","亚洲");
this[34][5] = new Option("非洲","非洲");
this[34][6] = new Option("虚拟社团","虚拟社团");
return this;
}
...
//子函数加省份
/*
* changelog 2007-02-28 增加了对非IE浏览器的支持
*/
...
for(var i=0;i<provinceOp.length;i++)
{
try{
...
for(var j=0;j<cityOp[i].length;j++)
{
//if (cityOp[i][j].text!=''){
try
{city.add(cityOp[i][j]);}
