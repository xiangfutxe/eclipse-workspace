  ...
  <body>
   ...
   <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span>出库管理
        ...
        <div class="result-wrap">
           ...
           <li>
               ...
               <li>
          继续 <a href="admin/InventoryServlet?method=apply_out_add"> 新增出库</a>&nbsp;或&nbsp;查看<a href="admin/InventoryServlet?method=apply_out">出库列表</a>
             </li>
              </ul>
 </div>
