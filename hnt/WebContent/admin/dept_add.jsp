  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span>员工管理<span class="crumb-step">&gt;</span><span>新增部门</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/DeptServlet?method=saveDept" method="post" id="myform" name="myform">
...
$(function() {
	$("#name").blur(function() {
		$.ajax({
				type : "post",
				url : "admin/DeptServlet?method=isDeptExit",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
					name : $("#name").val()
