...
String payTag = (String) request.getAttribute("payTag");
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.jsp">首页</a><span
						...
						class="crumb-step">&gt;</span><span class="crumb-name">奖金汇总</span>
					
				</div>
			</div>
				<div class="search-wrap">
				<div class="search-content">
					<form action="admin/RewardServlet?method=admin_reward_week_summary" id="searchForm"
						method="post">
						...
						if(slist.size()>0){
							...
							%>
								...
								状态：<select name="payTag" id="payTag">
								<option value="" <%if(StringUtil.notNull(payTag).equals("")){ %>selected<%} %>>全部</option>
								<option value="1" <%if(StringUtil.notNull(payTag).equals("1")){ %>selected<%} %>>正常</option>
								<option value="0" <%if(StringUtil.notNull(payTag).equals("0")){ %>selected<%} %>>冻结</option>
								</select>
			...
			<div class="result-wrap">
				<div class="result-content">
					<table class="result-tab" width="98%">
						<tr>
							<th>起止时间</th><th>类型</th><th>新增金额</th><th>新增业绩</th><th>创业奖</th><th>推荐奖</th><th>见点奖</th><th>拓展奖</th><th>培育奖</th><th>领导奖</th><th>物流补助</th><th>消费奖</th><th>奖金小计</th><th>复消</th><th>扣税</th><th>实发金额</th>
						</tr>
