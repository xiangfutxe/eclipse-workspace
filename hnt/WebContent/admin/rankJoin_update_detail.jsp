...
String token = (String)request.getSession().getAttribute("token");
	if (admin == null) {
		...
		if(rankstr[1][19].equals("1")||admin.getState().equals("1")){
  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span>会员管理<span class="crumb-step">&gt;</span><span>级别调整</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/JoinUpdateDetailServlet?method=admin_save" method="post" id="myform" name="myform" >
                                    ...
                                    <select id="rankJoin" name="rankJoin" class="common-text required">
										 <%if(up_user.getRankJoin()==0){ %>
										  ...
										  <%}else if(up_user.getRankJoin()==3){ %>
										   <option value="1">银卡会员</option>
										    <option value="2">金卡会员</option>
									  <%}else if(up_user.getRankJoin()==4){ %>
									   <option value="1">银卡会员</option>
										    <option value="2">金卡会员</option>
									  <option value="3">白金会员</option>
										  <%}else if(up_user.getRankJoin()==5){ %>
										  <option value="1">银卡会员</option>
										    <option value="2">金卡会员</option>
									  <option value="3">白金会员</option>
