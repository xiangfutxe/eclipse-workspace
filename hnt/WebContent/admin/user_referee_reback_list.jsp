		 ...
		 $("#exportExcel").click(function(){
	  	  if (!confirm("确认提交导出Excel？")) {
				return false;
	       		...
	       		$("#searchForm").attr("action", "admin/UserServlet?method=exportExcel_referee_reback");
				$("#searchForm").submit();
	       		 return true;
			}
		 });
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.jsp">首页</a><span
						...
						<span
						class="crumb-step">&gt;</span><span class="crumb-name">服务关系(反向)</span>
				</div>
			</div>
			<div class="search-wrap">
				<div class="search-content">
					<form action="admin/UserServlet?method=admin_referee_reback_list" id="searchForm"
						method="post">
...
<td><%=StringUtil.parseToString(user.getEntryTime(), DateUtil.yyyyMMddHHmmss)%></td>
 <td><%if(user.getState()==2){%>在线<%}else {%>下线<%}%></td>
 </tr>
	 	<%
	 	tag--;}}
				 ...
				 <div class="list-page"> 
                   ...
                   <form name="pageSizeForm"  action="admin/UserServlet?method=admin_referee_reback_list" method="post">
			...
			<form name="pageNoForm"  action="admin/UserServlet?method=admin_referee_reback_list" method="post">
					...
					<a
						href="admin/UserServlet?method=admin_referee_reback_list&pageSizeStr=<%=pager.getPageSize()%>&pageNoStr=1
						&userId=<%=StringUtil.notNull(userId)%>">首页</a> | <a
						href="admin/UserServlet?method=admin_referee_reback_list&pageSizeStr=<%=pager.getPageSize()%>&pageNoStr=<%=pager.getPageNo()-1%>
                 ...
                 <%if(pager.getPageNo()!=pager.getPageCount()) {%>
                    ...
                    下一页</a> | <a
						href="admin/UserServlet?method=admin_referee_reback_list&pageSizeStr=<%=pager.getPageSize()%>&pageNoStr=<%=pager.getPageCount()%>
