   ...
   <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/ProductTypeServlet?method=saveProductType" method="post" id="myform" name="myform">
...
$(function() {
	$("#typeName").blur(function() {
		$.ajax({
				type : "post",
				url : "admin/ProductTypeServlet?method=isProductTypeExit",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
