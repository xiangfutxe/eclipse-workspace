  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <span class="crumb-step">&gt;</span>会员管理<span class="crumb-step">&gt;</span>
            <span>会员列表<span class="crumb-step">&gt;</span>详情</span></div>
        </div>
         <div class="result-wrap">
         <form  action="admin/UserServlet?method=admin_user_update"  id="myform" name="myform" method="post">
                        ...
                        <tbody>
						  ...
						  <tr>
                             ...
                             <tr>
                                ...
                                <option value="护照"  <%if(user.getDocumentType().equals("护照")){%>selected<%} %>>护照</option>
                                </select>
