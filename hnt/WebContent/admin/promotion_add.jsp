  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            ...
            <a class="crumb-name">系统设置</a>
            <span class="crumb-step">&gt;</span><span>新增政策</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form method="post" id="myform" name="myform" action="admin/PromotionServlet?method=savePro">
                    ...
                    <table class="insert-tab" width="97%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="name" name="name"  type="text">&nbsp;<span id="nameTag"></span>
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>参数1：</th>
                                <td>
                                    <input class="common-text required" id="num1" name="num1" value="0" type="text">&nbsp;<span id="num1Tag"></span>
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>参数2：</th>
                                <td>
                                    <input class="common-text required" id="num2" name="num2"  value="0" type="text">&nbsp;<span id="num2Tag"></span>
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>参数3：</th>
                                <td>
                                    <input class="common-text required" id="num3" name="num3" value="0" type="text">&nbsp;<span id="num3Tag"></span>
                                </td>
                            </tr>
							 <tr>
                                <th><i class="require-red">*</i>参数4：</th>
                                <td>
                                    <input class="common-text required" id="num4" name="num4" value="0" type="text">&nbsp;<span id="num4Tag"></span>
                                </td>
                            </tr>
							  <tr>
                                <th><i class="require-red">*</i>参数5：</th>
                                <td>
                                    <input class="common-text required" id="num5" name="num5" value="0" type="text">&nbsp;<span id="num5Tag"></span>
                                </td>
                            </tr>
							  <tr>
                                <th><i class="require-red">*</i>开始时间</th>
                                <td>
                                    <input class="common-text required" id="startTime" name="startTime"  type="text">&nbsp;<span id="startTimeTag"></span>
                                </td>
                            </tr>
							  <tr>
                                <th><i class="require-red">*</i>结束时间</th>
                                <td>
                                    <input class="common-text required" id="endTime" name="endTime"  type="text">&nbsp;<span id="endTimeTag"></span>
                                </td>
                            </tr>
							  <tr>
                                <th><i class="require-red">*</i>摘要</th>
                                <td>
                                    <input class="common-text required" id="summary" name="summary" value="" type="text">&nbsp;<span id="summaryTag"></span>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
...
$(function() {
	...
	$("#name").blur(function() {
		$.ajax({
				type : "post",
				url : "admin/PromotionServlet?method=isExit",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
				...
				success : function(data) {
					...
					if(d.tag=="0") $("#nameTag").text("促销政策名不能为空！").css({"color":"red","font-size":"12px"});
					else if(d.tag=="1")  $("#nameTag").text("促销政策名已存在！").css({"color":"red","font-size":"12px"});
					else if(d.tag=="2")  $("#nameTag").text("促销政策名可用！").css({"color":"green","font-size":"12px"});
					else $("#nameTag").text("");
					
					if(getByteLen($(this).val())>50) $("#nameTag").text("促销政策名字数不能大于25！").css({"color":"red","font-size":"12px"});
				},
				error : function() {
					alert("系统异常，请稍后重试！");
				}//这里不要加","
