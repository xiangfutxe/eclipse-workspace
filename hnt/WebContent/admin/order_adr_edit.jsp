   ...
   <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/OrderServlet?method=admin_order_adr_update" method="post" id="myform" name="myform">
               ...
               <input type="hidden" name="orderId" id="orderId" value="<%=orders.getOrderId()%>"/> 
                 <input type="hidden" name="userId" id="userId" value="<%=orders.getUserId()%>"/> 
