   ...
   <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/ProductSortServlet?method=updateProductSort" method="post" id="myform" name="myform">
                  <input type="hidden" name="token" id="token" value="<%=StringUtil.notNull(token)%>"/> 
                  <input type="hidden" name="id" id="id" value="${requestScope.ProductSort.id }"/> 
                    ...
                    <table class="insert-tab" width="97%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="typeName" name="typeName"  value="${requestScope.ProductSort.typeName }" type="text">&nbsp;<span id="nameTag"></span>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
...
$(function() {
	$("#typeName").blur(function() {
		$.ajax({
				type : "post",
				url : "admin/ProductSortServlet?method=isProductSortExitUpdate",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
				id:$("#id").val(),
