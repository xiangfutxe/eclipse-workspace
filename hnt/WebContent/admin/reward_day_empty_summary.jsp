...
String startTime = (String) request.getAttribute("startTime");
	if (admin == null) {
		...
		if(rankstr[7][23].equals("1")||admin.getState().equals("1")){
%>
			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.jsp">首页</a><span
						...
						class="crumb-step">&gt;</span><span class="crumb-name">空单奖金汇总</span>
					
				</div>
			</div>
				<div class="search-wrap">
				<div class="search-content">
					<form action="admin/DRewardServlet?method=admin_reward_day_empty_summary" id="searchForm"
						method="post">
