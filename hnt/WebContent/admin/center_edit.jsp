   ...
   <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                   <form action="admin/CenterServlet?method=admin_edit_save" method="post" id="myform" name="myform">
                        ...
                        <tbody>
                            <tr>
                             ...
                             <tr>
                                ...
                                <td>
                               <%if(center.getType()==1) {%> 工作室
								<%}else if(center.getType()==2) {%>发货中心
								<%}else if(center.getType()==3) {%>运营中心
								<%} %></td>
                            </tr>
                               <tr>
							...
							id="measure" value="<%=StringUtil.notNull(center.getMeasure()) %>">&nbsp;<span id="licenseTag"></span></td>
                            </tr>
                             <tr>
                                <th width="150px"><i class="require-red"></i>营业执照：</th>
                                <td><input type="text" name="license"
							id="license" value="<%=StringUtil.notNull(center.getLicense()) %>">&nbsp;<span id="licenseTag"></span></td>
                            </tr>
                             <tr>
                                <th></th>
                                <td>
