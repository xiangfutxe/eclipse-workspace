  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span>会员管理<span class="crumb-step">&gt;</span><span>接点关系变更</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/UserServlet?method=admin_belong_update_save" method="post" id="myform" name="myform" >
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                             ...
                             <tr>
                                <th><i class="require-red">*</i>当前接点人：</th>
                                <td>
                              <%=up_user.getUserByBelongId()%>
                              <input type="hidden" id="refereeId" name="refereeId" value="<%=up_user.getUserByRefereeId() %>"/>
                                </td>
                            </tr>
                           
                              <tr>
                                <th><i class="require-red">*</i>最新接点人：</th>
                                <td>
                                   <input type="text" name="belongId" id="belongId">
										  &nbsp;<span id="belongUser"></span> &nbsp;<span id="belongUser1"></span>
                                </td>
                                </tr>
                                <tr>
