			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i><a href="admin/index.jsp">首页</a><span
						class="crumb-step">&gt;</span>订单管理<span class="crumb-step">&gt;</span><span>订单列表</span><span class="crumb-step">&gt;</span><span>订单汇总</span>
				</div>
			</div>
					...
					<div class="result-content">
						...
						if(coll!=null){
 						...
 						<tr <%if(t%2==1){%>class="even"<%}%>>
										...
										<td><%=StringUtil.decimalFormat(od.getPv()) %>
										</td>
									</tr>
							<%}%>
							...
							<td><%=coll.get(0).getPv() %></td>
							</tr>
							<tr><td colspan="9">汇总订单编号：<%=orderId %></td></tr>
							<%
