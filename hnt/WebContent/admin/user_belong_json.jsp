...
<form action="admin/UserServlet?method=admin_getBelong" id="searchForm" method="post">
  ...
  <%if(request.getAttribute("userJson")!=null){ %>      <ul id="treeDemo" class="ztree"></ul>
  <%} %>
    </div>
    </div>
    </div>
    ...
    <SCRIPT type="text/javascript">
        var setting = {  
                ...
                async: {
                    enable: true,
                    url:"admin/UserServlet?method=admin_belongJson",
