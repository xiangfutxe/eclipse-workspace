  ...
  <body>
   ...
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span>会员管理<span class="crumb-step">&gt;</span><span><a href="admin/UserServlet.do?method=rankJoin_up_list">升级管理</a></span>
        ...
        <div class="result-wrap">
           ...
           <li>
              <%=StringUtil.notNull(message)%>
               ...
               <li>
           继续<a href="admin/JoinInfoServlet?method=admin_list"> 升级管理</a>
             </li>
              </ul>
 </div>
