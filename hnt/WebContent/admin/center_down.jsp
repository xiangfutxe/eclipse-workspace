   ...
   <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                   <form action="admin/CenterServlet?method=admin_down_save" method="post" id="myform" name="myform">
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
							...
							id="nameTag"></span></td>
                             ...
                             <tr>
                                <th width="150px"><i class="require-red">*</i>降级类型：</th>
                                <td>
                              <select name="typeNew" id="typeNew">
                               <option value="1">资格点</option>
