  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span>会员管理<span class="crumb-step">&gt;</span><span>实单升级</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                 <form action="admin/UserServlet?method=admin_user_empty_update" method="post" id="myform" name="myform">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                              ...
                              <tr>
                                <th width="150px"><i class="require-red">*</i>升级类型：</th>
                                <td><input type="radio" name="type" id="type" value='1' checked>升级为实单
                                &nbsp;<input type="radio" name="type" id="type" value='2'>转为空单&nbsp;
                                <input type="radio" name="type" id="type" value='3'>升级分红单&nbsp;<span id="typeTag"></span>
                                </td>
                            </tr>
                             <tr>
                                <tr>
	 ...
	 if (!confirm("确认提交？")) {
		...
		if($("#userId").val()==""){
		 ...
		 if ($(":radio:checked").length == 0){
				$("#typeTag").text("未选择升级类型！").css({"color":"red","font-size":"12px"});
				errorstr ="1";
		}else $("#typeTag").text("");
