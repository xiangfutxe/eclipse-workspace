		 ...
		 $("#exportExcel").click(function(){
	  	  if (!confirm("确认提交导出Excel？")) {
				return false;
	       		...
	       		$("#searchForm").attr("action", "admin/UserServlet?method=exportExcel_user_money_list");
				$("#searchForm").submit();
	       		 return true;
			}
		 });
		 	...
		 	$("#user_hide_list").click(function() {
				$('#myform').attr("action", "admin/UserServlet?method=admin_user_money_hide_list");
				$('#myform').submit();
					return true;
		});
		...
		<div class="main-wrap">
			...
			<div class="search-wrap">
				<div class="search-content">
					<form action="admin/UserServlet?method=admin_user_money_list" id="searchForm"
						method="post">
				 ...
				 <div class="result-title">
                    <div class="result-list">
                      <%if(rankstr[2][6].equals("1")||admin.getState().equals("1")){ %>
                       ...
                       <button id="user_hide_list" class="btn"><i class="icon-font">&#xe022;</i>隐藏列表</button>
                 <%} %>
                    </div>
                </div>
...
<td><%=StringUtil.decimalFormat(user.getTotalIncome())%></td>
	 	...
	 	<%}}
				 ...
				 <div class="list-page"> 
                   ...
                   <form name="pageSizeForm"  action="admin/UserServlet?method=admin_user_money_list" method="post">
			...
			<form name="pageNoForm"  action="admin/UserServlet?method=admin_user_money_list" method="post">
					...
					<a
						href="admin/UserServlet?method=admin_user_money_list&pageSizeStr=<%=pager.getPageSize()%>&pageNoStr=1
						&userId=<%=StringUtil.notNull(userId)%>">首页</a> | <a
						href="admin/UserServlet?method=admin_user_money_list&pageSizeStr=<%=pager.getPageSize()%>&pageNoStr=<%=pager.getPageNo()-1%>
                 ...
                 <%if(pager.getPageNo()!=pager.getPageCount()) {%>
                    ...
                    下一页</a> | <a
						href="admin/UserServlet?method=admin_user_money_list&pageSizeStr=<%=pager.getPageSize()%>&pageNoStr=<%=pager.getPageCount()%>
