  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="admin/BankAccountServlet?method=list">账号管理</a><span class="crumb-step">&gt;</span><span>新增账号</span></div>
        </div>
...
$(function() {
	...
	$("#sbtn").click(function(){
		...
		if(errorstr!=""){
			...
			$('#myform').attr("action","admin/BankAccountServlet?method=save");
	       	$('#myform').submit();
       		 return true;
