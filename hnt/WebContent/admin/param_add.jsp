   ...
   <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form method="post" id="myform" name="myform" action="admin/ParamServlet?method=saveParam">
...
$(function() {
	...
	$("#paramName").blur(function() {
		$.ajax({
				type : "post",
				url : "admin/ParamServlet?method=isParamExit",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
