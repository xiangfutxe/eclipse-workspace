...
<%@page import="com.ssm.pojo.Param" %>
<%
...
out.println("</script>");
	...
	String[][] rankstr = StringUtil.getRankStr(admin.getRank());
		if(rankstr[9][16].equals("1")||admin.getState().equals("1")){
%>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="paramName" name="paramName" value="<%=StringUtil.notNull(param.getParamName()) %>" type="text">&nbsp;<span id="nameTag"></span>
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>参数1：</th>
                                <td>
                                    <input class="common-text required" id="amount_1" name="amount_1" value='<%=StringUtil.decimalFormat2(param.getAmount_1()) %>' type="text">&nbsp;<span id="amount_1Tag"></span>
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>参数2：</th>
                                <td>
                                    <input class="common-text required" id="amount_2" name="amount_2"  value='<%=StringUtil.decimalFormat2(param.getAmount_2()) %>' type="text">&nbsp;<span id="amount_2Tag"></span>
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>参数3：</th>
                                <td>
                                    <input class="common-text required" id="amount_3" name="amount_3" value='<%=StringUtil.decimalFormat2(param.getAmount_3()) %>' type="text">&nbsp;<span id="amount_3Tag"></span>
                                </td>
                            </tr>
							 <tr>
                                <th><i class="require-red">*</i>参数4：</th>
                                <td>
                                    <input class="common-text required" id="amount_4" name="amount_4" value='<%=StringUtil.decimalFormat2(param.getAmount_4()) %>' type="text">&nbsp;<span id="amount_4Tag"></span>
                                </td>
                            </tr>
							  <tr>
                                <th><i class="require-red">*</i>参数5：</th>
                                <td>
                                    <input class="common-text required" id="amount_5" name="amount_5" value='<%=StringUtil.decimalFormat2(param.getAmount_5()) %>' type="text">&nbsp;<span id="amount_5Tag"></span>
                                </td>
                            </tr>
							  <tr>
                                <th><i class="require-red">*</i>参数6：</th>
                                <td>
                                    <input class="common-text required" id="amount_6" name="amount_6" value='<%=StringUtil.decimalFormat2(param.getAmount_6()) %>' type="text">&nbsp;<span id="amount_6Tag"></span>
                                </td>
                            </tr>
							  <tr>
                                <th><i class="require-red">*</i>参数7：</th>
                                <td>
                                    <input class="common-text required" id="amount_7" name="amount_7" value='<%=StringUtil.decimalFormat2(param.getAmount_7()) %>' type="text">&nbsp;<span id="amount_7Tag"></span>
                                </td>
                            </tr>
							  <tr>
                                <th><i class="require-red">*</i>参数8：</th>
                                <td>
                                    <input class="common-text required" id="amount_8" name="amount_8" value='<%=StringUtil.decimalFormat2(param.getAmount_8()) %>' type="text">&nbsp;<span id="amount_8Tag"></span>
                                </td>
                            </tr>
							 <tr>
                                <th><i class="require-red">*</i>参数9：</th>
                                <td>
                                    <input class="common-text required" id="amount_9" name="amount_9" value='<%=StringUtil.decimalFormat2(param.getAmount_9()) %>' type="text">&nbsp;<span id="amount_9Tag"></span>
                                </td>
                            </tr>
							 <tr>
                                <th><i class="require-red">*</i>参数10：</th>
                                <td>
                                    <input class="common-text required" id="amount_10" name="amount_10" value='<%=StringUtil.decimalFormat2(param.getAmount_10()) %>' type="text">&nbsp;<span id="amount_10Tag"></span>
                                </td>
                            </tr>
                             <tr>
                                <th>单位：</th>
                                <td>
                                    <input class="common-text required" id="unit" name="unit" value="<%=StringUtil.notNull(param.getUnit()) %>" type="text">&nbsp;<span id="unitTag"></span>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
...
$(function() {
	...
	$("#paramName").change(function() {
		$.ajax({
				type : "post",
				url : "admin/ParamServlet?method=isParamExitUpdate",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				param : {//设置数据源
					id:$("#id").val(),
	...
	$("#sbtn").click(function(){
		...
		if(errorstr!=""){
			...
			$('#myform').attr("action", "admin/ParamServlet?method=updateParam");
	       	$('#myform').submit();
       		 return ture;
