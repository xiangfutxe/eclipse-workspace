						...
						<table class="search-tab">
							<tr>
								...
								&nbsp;<input class="btn btn-primary" id="exportExcel_orders"
									name="exportExcel_orders" value="导出伞下推荐会员信息" type="submit">
									
									&nbsp;<input class="btn btn-primary" id="exportExcel_2"
									name="exportExcel_2" value="导出伞下安置会员信息" type="submit">&nbsp;<span
	...
	$(function() {
			...
			if($("#userId").val()==""){
				...
				return false;
	       		...
	       		$("#searchForm").attr("action", "admin/ReportServlet?method=admin_report_export_referee_user");
				$("#searchForm").submit();
	       		 return true;
	       		 }
			}
		  ...
		  $("#exportExcel_2").click(function(){
	  	  if (!confirm("确认提交导出伞下安置会员信息？")) {
				return false;
			}
			else{
			if($("#userId").val()==""){
				...
				return false;
	       		...
	       		$("#searchForm").attr("action", "admin/ReportServlet?method=admin_report_export_belong_user");
				$("#searchForm").submit();
	       		 return true;
	       		 }
			}
