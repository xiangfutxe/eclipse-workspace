  ...
  <div class="container clearfix">
   <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="admin/index.jsp">首页</a><span class="crumb-step">&gt;</span>员工管理<span class="crumb-step">&gt;</span><span>修改职务</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="admin/JobServlet?method=updateJob" method="post" id="myform" name="myform">
                <input type="hidden" name="id" id="id" value="${requestScope.Job.id }"/> 
                    ...
                    <table class="insert-tab" width="97%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="name" name="name"  value="${requestScope.Job.name }" type="text">&nbsp;<span id="nameTag"></span>
                             ...
                             <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="remark" name="remark" value="${requestScope.Job.remark}" type="text">&nbsp;<span id="remarkTag"></span>
                                </td>
                            </tr>
                            <tr>
                                <th></th>
...
$(function() {
	$("#name").blur(function() {
		$.ajax({
				type : "post",
				url : "admin/JobServlet?method=isJobExitUpdate",//需要用来处理ajax请求的action,excuteAjax为处理的方法名，JsonAction为action名
				data : {//设置数据源
				id:$("#id").val(),
					name : $("#name").val()
